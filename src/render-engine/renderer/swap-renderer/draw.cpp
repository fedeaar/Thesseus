...
RenderEngine::Status
RenderEngine::SwapRenderer::draw(
  VkCommandBuffer cmd,
  u32 img_idx,
  ResourceManagement::VulkanManager::Swapchain::Swapchain& swapchain)
{
  ...
  RenderEngine::SwapRenderer::ComputeEffect& effect = effects_[current_effect_];
  vkCmdBindPipeline(
  ...
  ResourceManagement::VulkanManager::Image::copy_image(cmd,
                                                       swapchain.draw_img.image,
                                                       swapchain.imgs[img_idx],
