...
Status
RenderEngine::VulkanManager::Descriptor::Allocator::init_pool(
  VkDevice device,
  u32 max_sets,
...
Status
RenderEngine::VulkanManager::Descriptor::Allocator::destroy_pool(
  VkDevice device)
{
...
Status
RenderEngine::VulkanManager::Descriptor::Allocator::clear(VkDevice device)
{
  return check(vkResetDescriptorPool(device, pool, 0));
}

core::Result<VkDescriptorSet, Status>
RenderEngine::VulkanManager::Descriptor::Allocator::allocate(
  VkDevice device,
