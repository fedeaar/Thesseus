...
ResourceManagement::VulkanManager::Descriptor::Allocator::init_pool(
  VkDevice device,
  u32 max_sets,
...
ResourceManagement::Status
ResourceManagement::VulkanManager::Descriptor::Allocator::destroy_pool(
  VkDevice device)
{
...
ResourceManagement::Status
ResourceManagement::VulkanManager::Descriptor::Allocator::clear(VkDevice device)
{
  return check(vkResetDescriptorPool(device, pool, 0));
}

core::Result<VkDescriptorSet, ResourceManagement::Status>
ResourceManagement::VulkanManager::Descriptor::Allocator::allocate(
  VkDevice device,
